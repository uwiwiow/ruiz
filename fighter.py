...
class Texto_daño(pygame.sprite.Sprite):
    def __init__(self, x, y, damage, colour):
        pygame.sprite.Sprite.__init__(self)
        damage_font = pygame.font.Font("assets/fonts/turok.ttf", 26)
        self.image = damage_font.render(damage, True, colour)
    ...
    def attack(self, target, attack_type):
        if self.attack_cooldown == 0:
            ...
            if attacking_rect.colliderect(target.rect):
                ...
                target.hit = True
                damage_text = Texto_daño(target.rect.centerx, target.rect.y, str(damage), "#FF0000")
